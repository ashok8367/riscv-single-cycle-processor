...
module Immidiate_generator ( instruction , ImmExt);
    ...
    7'b0110111: ImmExt = {instruction[31:12], 12'b0}; // U-type ----> LUI
	7'b0010111: ImmExt = {instruction[31:12], 12'b0}; // U-type ----> AUIPC
    7'b1101111: ImmExt = {{11{instruction[31]}}, instruction[19:12], instruction[20], instruction[30:21], 1'b0}; // J-type ----> JAL
    7'b1100111: ImmExt = {{20{instruction[31]}}, instruction[31:20]}; // I-type ----> JALR
